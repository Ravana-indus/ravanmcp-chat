...
const tools = [
    ...
    },
    {
        ...
        function: {
            ...
            description: "Get the list of fields for a specific DocType in ERPNext",
            parameters: {
                type: "object",
                properties: {
    ...
    },
    {
        ...
        function: {
            name: "get_documents",
            description: "Get a list of documents for a specific DocType in ERPNext",
            parameters: {
                type: "object",
                properties: {
...
const getSystemPrompt = () => {
    return `You are an intelligent ERPNext AI Assistant. You help users interact with their ERP system efficiently and provide detailed, formatted responses.

## Capabilities:
- **Data Retrieval**: Search customers, items, sales orders, reports, etc.
- **Document Management**: Create, update, and manage ERP documents
- **Report Generation**: Run various ERP reports and analytics
...
app.listen(port, () => {
    console.log(`🚀 ERPNext Chat Backend (Simplified) running on port ${port}`);
